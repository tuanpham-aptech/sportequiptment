        ...
        <div class="header">
            <nav class="header__navbar">
                <ul class="header__navbar-list">
                    ...
                    <li class="header__navbar-item">
                        <a href="index.php?option=list_product" class="header__navbar-link"><span>Sản phẩm</span></a>
                    </li>
                    <li class="header__navbar-item">
            ...
            <div class="header__search-wraper">
                ...
                <div class="header__search--search">
                  <form method="GET" class="search-form">
                    ...
                    <button class="header__search--search-btn" onclick="location='?option=show_products' "><i class="fas fa-search"></i></button>
                  </form>
                  <?php if(empty($_SESSION['member'])):?>
            ...
            <div class="header__search-mobile">
                ...
                <div class="header__search--search">
                  <form action="" method="get" class="search-form">
                    <input type="search" name ="search" class="header__search--search-input" placeholder="Nhập từ khoá tìm kiếm ">
                    <button class="header__search--search-btn"><i class="fas fa-search"></i></button>
                  </form>
                  <?php if(empty($_SESSION['member'])):?>
                    <a href="index.php?option=cart" class="header__search--cart"><i class="fas fa-shopping-cart"></i></a>
                  <?php else: ?>
