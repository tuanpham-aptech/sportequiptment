...
if(isset($_POST['title'])){
    ...
    // điều kiện 1 là tên có trùng với tên người dùng nhập hay chọn không và kiểm tra xem có sản phẩm nào khác với sản phẩm này
    // mà có tên giống với tên mà ta chuẩn bị update không 
    // trong đó product_id của vế và là toàn bộ id trong bảng products 
    //so sánh từng sản phẩm một với $row_product['product_id] của sản phẩm đang sửa 
    ...
    if(mysqli_num_rows($result) !=0){
        ...
        // lấy nguồn do ban đầu ảnh chỉ lưu ở nguồn tạm của window nên h ta cần lấy vị trí đó 
        $imageTemp = $_FILES['image']['tmp_name'];
        // lấy đuôi mở rộng của ảnh với 3 kí tự sử dụng hàm substr có 2 tham số tham số 1 là chuỗi cần lấy tham số thứ 2 là vị trí bắt đầu cần lấy 
        $exp3 = substr($imageName,strlen($imageName)-3);// ví dụ abcd.jpg thì nó sẽ lấy từ jpg từ vị trí số 5 
        // lấy đuôi mở rộng của ảnh với 4 kí tự sử dụng hàm substr có 2 tham số tham số 1 là chuỗi cần lấy tham số thứ 2 là vị trí bắt đầu cần lấy 
