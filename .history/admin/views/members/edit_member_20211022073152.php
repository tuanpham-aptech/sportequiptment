<?php if(isset($_GET['id'])){
    ...
    if(isset($_POST['username'])){
        ...
        if(mysqli_num_rows($result) != 0){
            ...
            echo "<script>alert('Bạn đã cập thành công tài khoản!!!')</script>";
        }
    }
}
?>
                        ...
                        <tbody>
                            <form class="member-form" method="post">
                                ...
                                <tr class="member-table--tr">
                                  ...
                                  <td class="member-table--td"><input type="password" name="password" value="<?=$row_mem['password'];?>"></td>
                                </tr>
                                <tr class="member-table--tr">
                                    <td class="member-table--td">Họ và tên  :</td>
                                    <td class="member-table--td"><input type="text" value="<?=$row_mem['fullname'];?>" name="fullname" id=""></td>
                                </tr>
                                <tr class="member-table--tr">
                                    <td class="member-table--td">Số điện thoại :</td>
                                    <td class="member-table--td"><input type="number" value="<?=$row_mem['mobile'];?>" name="mobile" id=""></td>
                                </tr>
                                <tr class="member-table--tr">
                                    <td class="member-table--td">Địa chỉ :</td>
                                    <td class="member-table--td"><input type="text" name="address" value="<?=$row_mem['address'];?>"> </td>
                                </tr>
                                <tr class="member-table--tr">
                                    <td class="member-table--td">Email</td>
                                    <td class="member-table--td"><input type="email" value="<?=$row_mem['email'];?>" name="email"></td>
                                </tr>
                                <tr class="member-table--tr">
