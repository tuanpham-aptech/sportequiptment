                    ...
                    <table class="member-table">
                        ...
                        <?php foreach ($result as $member):?>
                          <tr  class="member-table--tr">
                            ...
                            <td class="member-table--td"><a href="?option=list_member&id=<?=$pro['member_id'];?>" onclick ="return confirm('Bạn có chắc muốn xoá thành viên này  ?')" class="btn btn--primary"> </a> </td>
